...
const features = [
  ...
  },
  {
    ...
    type: "Benefit",
    description:
      "Our software acceleration tools are baked into the platform. Get more out of every hour of compute, making your stack run faster and leaner without extra manual tuning.",
  },
  {
