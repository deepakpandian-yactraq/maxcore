    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="font-bold text-xl tracking-tight glow-md">DePINtelligence</h1>
            <p className="text-xs text-light-200/80 font-semibold glow-sm">by Quantum Alchemy</p>
          </div>
        </div>
